...
hash value is again represented as a feature vector, where the returned
dimensions are either 0 or 1.
...
computed hash value is again represented as a feature vector, where the
returned dimensions are either 0 or 1.
