...
their simplicitiy, however, these methods only capture small amount of
information from the original feature vectors.
...
This parameter specifies the method used for dimension reduction. Supported
methods are: I<"none"> for no dimension reduction, I<"simhash"> for
computation of similarity hashs and I<"minhash"> for computation of 
minimum hashs.
